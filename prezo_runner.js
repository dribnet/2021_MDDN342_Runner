...
async function preload () {
  prezo_list = [
    ...
    },
    {
      ...
      "file": "cooper_training_values.json",
      "face": new CooperFace()
    },
    {
    ...
    },
    {
      ...
      "file": "campbell_training_values.json",
...
function setup () {
  ...
  littleFace = prezo_list[curSwapFace].face;
...
async function draw () {
  ...
  if(!isSwappingFaces && lastKeyPressedTime + 1000 * secondsUntilSwapMode < now) {
    isSwappingFaces = true;
  }
